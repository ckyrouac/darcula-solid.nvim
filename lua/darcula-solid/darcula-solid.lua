...
return lush(function(injected_functions)
  ...
  return {
    ...
    sym("ScrollbarSearchHandle")({ fg = colors.blue, bg = colors.bg_alt }),
    sym("ScrollbarSearch")({ fg = colors.blue, bg = colors.blue }),
    sym("ScrollbarErrorHandle")({ fg = colors.red, bg = colors.bg_alt }),
    sym("ScrollbarError")({ fg = colors.red, bg = colors.bg }),
    sym("ScrollbarWarnHandle")({ fg = colors.orange, bg = colors.bg_alt }),
    sym("ScrollbarWarn")({ fg = colors.orange, bg = colors.bg }),
    sym("ScrollbarInfoHandle")({ fg = colors.yellow_alt, bg = colors.bg_alt }),
    sym("ScrollbarInfo")({ fg = colors.yellow_alt, bg = colors.bg }),
    sym("ScrollbarHintHandle")({ fg = colors.cyan, bg = colors.bg_alt }),
    sym("ScrollbarHint")({ fg = colors.cyan, bg = colors.bg }),
    sym("ScrollbarMiscHandle")({ fg = colors.fg, bg = colors.bg_alt }),
    sym("ScrollbarMisc")({ fg = colors.fg, bg = colors.bg }),
    sym("ScrollbarGitAdd")({ fg = colors.green, bg = colors.bg }),
    sym("ScrollbarGitAddHandle")({ fg = colors.green, bg = colors.bg_alt }),
    sym("ScrollbarGitChange")({ fg = colors.blue, bg = colors.bg }),
    sym("ScrollbarGitChangeHandle")({ fg = colors.blue, bg = colors.bg_alt }),
    sym("ScrollbarGitDelete")({ fg = colors.red, bg = colors.bg }),
    sym("ScrollbarGitDeleteHandle")({ fg = colors.red, bg = colors.bg_alt }),
